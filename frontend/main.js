...
$("#createTodoButton").click(function () {
  createTodo($("#createTodoInput").val(), $("#companyName").val());
});
...
// TODOの作成
function createTodo(msg, companyName) {
  createABI(msg, companyName).then(() =>
    displayTodo().then(() => {
      $("#createTodoInput").val("");
      $("#companyName").val("");
    })
...
async function createABI(contents, companyName) {
  await contract.methods
    .createTODO(contents, companyName)
